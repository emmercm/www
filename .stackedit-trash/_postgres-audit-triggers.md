...
The "hidden" complexity of the function is mitigated by the fact it doesn't contain any business logic, only logic to insert into a table that only humans will query.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxNjY3MTk1NF19
-->