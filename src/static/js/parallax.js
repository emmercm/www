...
$(document).ready(function () {
    // http://detectmobilebrowsers.com/ 2014/08/01
    function isMobile() {
    ...
    // https://stackoverflow.com/questions/263965/how-can-i-convert-a-string-to-boolean-in-javascript#comment25068645_1414175
    function isTrue(str) {
    ...
    $("[data-parallax][data-parallax!='']").each(function () {
        ...
        // Don't do parallax on mobile if data-parallax-mobile=false
        if (isMobile() && !isTrue($elem.attr('data-parallax-mobile'))) {
            return;
        }

        // Eliminate transition lag
