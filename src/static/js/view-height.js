...
function viewHeight() {
    ...
    var newViewHeightOrientation = $(window).height() > $(window).width() ? 'portrait' : 'landscape';

    // Fire if: is desktop, or mobile orientation has changed
    if (!isMobile() || newViewHeightOrientation !== viewHeightOrientation) {
        document.documentElement.style.setProperty('--vh', (window.innerHeight / 100) + 'px');
        viewHeightOrientation = newViewHeightOrientation;
    }
}
