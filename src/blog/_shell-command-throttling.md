...
[Claude Code](https://code.claude.com/docs/en/setup#auto-updates) only auto-updates "native" installations, which were introduced in v2.0. Before that, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzUzNzQwNDc4LC0xNjExNDI2ODkzLDE1Nz
