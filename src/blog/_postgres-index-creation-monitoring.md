...
Index creation is broken down into "phases" or steps, and the number increases if you use the `CONCURRENTLY` option. Different phases 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTg0NDQzMTcwLDYxNTQ3NTk2OCwxMjAzMz
MzMzc4LC0zNzQzNTE1MTYsLTE3ODM0OTI4NTAsLTc2ODU2MzQ1
Nl19
-->