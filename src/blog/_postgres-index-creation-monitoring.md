...
Index creation is broken down into "phases" or steps, and the number increases if you use the `CONCURRENTLY` keyword.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4NzU3MDEzNyw2MTU0NzU5NjgsMTIwMz
