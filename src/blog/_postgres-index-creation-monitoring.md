...
Index creation is broken down into "phases" or steps, and the number increases if you use the `CONCURRENTLY` option.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQxMzc5NTIxLDYxNTQ3NTk2OCwxMjAzMz
