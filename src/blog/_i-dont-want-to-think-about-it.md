...
Both of these two services are API-based, so the solution was to automate running them and calling their endpoints like a real 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNTMxODQwLDE1MzEwNDYwMjMsLTEwOT
