...
The solution for both services was to externalize the task queue and each task's status. If you track tasks with statuses such as "queued", "in-progress", "completed", or "failed" along with the timestamp they entered that state, then you recover from failure. Really any datastore will work for this, but a relational DB may make the most sense.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTM1ODM2MywxNDE0OTgwMTc4LDE5Mz
M4NDE0MTBdfQ==
-->