...
Obviously this testing strategy isn't a fool-proof plan. You should still test things like authorization and input validation in unit tests. And this end-to-end runtime 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0OTkwOTQ3NTgsMTUzMTA0NjAyMywtMT
