...
Logic in DB functions and triggers is separated from application logic which decreases discoverability.
...
## Alternative
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMTkyNTc3ODcsLTEwNTEwOTk0MjAsLT
