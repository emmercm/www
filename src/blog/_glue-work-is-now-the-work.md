...
Other standards and documentation you may want to co-locate with your code includes:

- Architectural decision records (ADRs)

You'll likely want to leave a breadcrumb to each of these in your `AGENTS.md` file so y
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODA3NjgzMTQsMTkwMDgyODkyMiwyMD
