...
date: 2025-12-19T05:41:00
image: https://unsplash.com/photos/bokeh-photography-of-red-lights-Egl6z2tZAdw
tags:
- microservices
- sre
...
When (not _if_) your service dies, do you have an EKG to tell you so?

It's important to be alerted when the processes you are responsible for are no longer having their expected outcome. Most of the time you want these alerts to be driven by well-defined [SLOs](/blog/slis-slos-and-slas-what-are-they). But an obvious failure mode that will lead to breaking SLOs are if a service _flatlines_, or it is no longer running or making any progress.
...
- **Service orchestration errors:** [Kubernetes](/blog/tag/kubernetes) or other compute orchestrators should emit metrics when they fail to schedule services or when services fail to start.
...
Thank about the services you operate now. If any of them died, would they make a loud noise like an EKG flatlining, or would you be none the wiser?
