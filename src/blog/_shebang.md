...
Using the `#! /usr/bin/env <interpreter>` style for shebangs is typically more "portable" (works more reliably across a wide variety of OSes environments).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3OTQyMzEyMywtOTYyNjQ5OTUsLTk2OD
